...
import { blockchainData } from "../Content/blockData";
import { transactionsData } from "../Content/transactionData";
      ...
      <div className="grid grid-cols-[repeat(auto-fill,_minmax(550px,_1fr))] gap-4 pt-4 pb-4 w-full">
                ...
                {blockchainData.map((block, index) => (
                  <tr key={index} className="border-b-1 border-[#eeeeee]">
                    ...
                    <td className="p-2 text-[14px] font-[500]">
                      ...
                      <p className="text-[#0d4c8f]"><Link href={`/block/${block.blockNumber}`}>{block.blockNumber}</Link></p>
                      <p>{block.timeAgo}</p>
                    </td>
                    <td className="p-2 text-[14px] font-[500]">
                        <p>Miner{" "}<span className="text-[#0d4c8f]">{block.miner}</span></p>
        ...
        <div className="rounded-[8px] bg-[#FFFFFF] border-1 shadow-md border-[#eeeeee] ">
          ...
          <div className="p-4">
            <table className="w-full border-collapse">
              <tbody>
                {transactionsData.map((block, index) => (
                  <tr key={index} className="border-b-1 border-[#eeeeee]">
                    <td className="w-[40px] h-[36px]">
                      <svg
                        width="34"
                        height="34"
                        viewBox="0 0 162 162"
                    ...
                    <td className="p-2 text-[14px] font-[500]">
                      <p className="text-[#0d4c8f] w-40 truncate">
                       <Link href={`/transaction/${block.hash}`}>{block.hash}</Link>
                      </p>
                      <p>{block.timeAgo}</p>
                    </td>
                    <td className="p-2 text-[14px] font-[500]">
                      <p>
                        From{" "}
                        <span className="text-[#0d4c8f]">{block.from}</span>{" "}
                      </p>
                      <p>To{" "}<span className="text-[#0d4c8f]"> {block.to}</span></p>
